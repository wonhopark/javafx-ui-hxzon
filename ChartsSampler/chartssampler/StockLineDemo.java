...
/**
 * Simulated Stock LineChart Demo
 */
public class StockLineDemo extends ChartDemo<LineChart<Number,Number>> {
    ...
    public StockLineDemo() {
        super("Stock Simulator");
        // create timeline to add new data every 60th of second
        animation = new Timeline();
        animation.getKeyFrames().add(new KeyFrame(Duration.valueOf(1000/60), new EventHandler<ActionEvent>() {
    ...
    @Override protected LineChart<Number, Number> createChart() {
