 ...
 */
public class CandleStickDemo extends ChartDemo<CandleStickChart> {
    ...
    public CandleStickDemo() {
        super("Custom Candle Stick Chart");
    }

    @Override protected CandleStickChart createChart() {
        ...
        for (int i=0; i< data.length; i++) {
            double[] day = data[i];
            series.getData().add(
                new XYChart.Data<Number,Number>(day[0],day[1],new CandleStickChart.CandleStickExtraValues(day[2],day[3],day[4],day[5]))
            );
        }
